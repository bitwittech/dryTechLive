...
const fetchURLs = async () => {
  return [
    ...
    {
      url: "/details/instant-fat-filled-powder",
      changefreq: "daily",
      priority: 0.8,
    },
    ...
    {
      url: "/appreciation-from-our-customer-speaks-more-than-our-actions",
      changefreq: "daily",
      priority: 1.0,
    },
    { url: "/our-certification", changefreq: "daily", priority: 1.0 },
    { url: "/details/tomato-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/tamarind-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/fruit-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/spray-aragum", changefreq: "daily", priority: 1.0 },
    {
      url: "/details/diesol-soluble-dietary-fiber",
      changefreq: "daily",
      priority: 1.0,
    },
    { url: "/details/fat-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/caseinate", changefreq: "daily", priority: 1.0 },
    { url: "/details/cheese-powder", changefreq: "daily", priority: 1.0 },
    {
      url: "/details/hydrolyzed-vegetable-protein",
      changefreq: "daily",
      priority: 1.0,
    },
    { url: "/details/lime-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/non-dairy-creamer", changefreq: "daily", priority: 1.0 },
    { url: "/details/beverage-whitener", changefreq: "daily", priority: 1.0 },
    { url: "/details/beetroot-powder", changefreq: "daily", priority: 1.0 },
    { url: "/details/caramel-color", changefreq: "daily", priority: 1.0 },
    {
      url: "/details/instant-fat-filled-powder",
      changefreq: "daily",
      priority: 1.0,
